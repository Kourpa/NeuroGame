...
public class Spark
{
  ...
  public Spark(double x, double y, World world)
  {
    ...
    pixelSize = Library.worldToScreen(0.001);
    pixelDeltaSize = Library.worldToScreen((Library.RANDOM.nextDouble()+0.5)/1000.0);
  ...
  public void draw(Graphics2D canvas)
  {
    ...
    int x0 = Library.worldToScreen(posX - world.getDeltaX());
    int y0 = Library.worldToScreen(posY);
...
//    g.setColor(new Color(YELLOW_R, YELLOW_G, YELLOW_B, alpha));
//    g.drawRect(x0-size2/2, y0-size2/2, size2, size2);
  }
}
