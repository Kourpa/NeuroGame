...
public class IOExecutor
{
   ...
   *          String to queue for logging.
   * @param risk
   *          Double of the risk to append to the String.
   */
   ...
   * @param logName
   *          String containing the log filename.
   */
  ...
  /**
   * Kill all current IO channels managed by the executor. Called when exiting
   * the program. Does nothing if Logger and Communicator are already closed.
   */
  public void killAll()
  {
    killLogger();
